export const en = {
  ...
  analytics: {
    ...
    export: "Export",
    exportUsageStatistics: "Export this device's local usage history",
    exportUsageSuccess: "Usage history exported to {{path}}",
    exportUsageError: "Failed to export usage history",
    importUsageStatistics: "Import usage history (replaces local data)",
    importUsageSuccess: "Imported {{added}} requests — usage history is now from this file",
    importUsageError: "Failed to import usage history",
    importUsageConfirmTitle: "Import Usage History",
    importUsageConfirmMessage: "Importing replaces this device's local usage history. Continue?",
